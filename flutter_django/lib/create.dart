...
class _CreateState extends State<Create> {
  ...
  Future<void> createdData() async {
    ...
    String url =
        'http://192.168.1.17:8000/create/'; // Remplacez ceci par l'URL de votre endpoint de mise à jour sur le serveur
    ...
    try {
      ...
      if (response.statusCode == 201) {
        ...
        print('Données créé avec succès');
    ...
    return Scaffold(
      ...
      children: [
        ...
        Container(
          ...
          child:
              Text("Entrer des nouveau donner pour creer un nouveau produit"),
        ),
        Container(
          height: 0,
        ),
        ...
        MaterialButton(
          ...
          child: Text("retourner à la liste"),
        ),
        ElevatedButton(
          onPressed: () {
              ...
              if (id == null) {
                ...
                showDialog(
                  ...
                  builder: (BuildContext context) {
                    return AlertDialog(
                      title: Text('Erreur'),
                      content: Text('L\'ID entré n\'est pas un nombre valide.'),
                      actions: <Widget>[
                        TextButton(
                          onPressed: () {
                            Navigator.of(context).pop();
                ...
                createdData(); // Appel à la fonction pour mettre à jour les données
              }
            }
          },
          child: Text('creer un nouveau produit'),
        ),
      ],
    ));
  }
